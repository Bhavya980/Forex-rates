...
package object http {
  ...
  implicit def currencyExchangeDecoder: Decoder[CurrencyExchange] = deriveDecoder[CurrencyExchange]
  implicit def listCurrencyExchangeDecoder: Decoder[List[CurrencyExchange]] = Decoder.decodeList[CurrencyExchange]
